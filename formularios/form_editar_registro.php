...
$resultado = mysqli_query($conexion, "SELECT * FROM equipo where id = $_REQUEST[id]") or
    ...
    <form class="d-grid gap-2" method="post" action="/../inventarioti/crud/editarRegistros/editar_registro.php">
        ...
        <div class="col-sm ">
            <div class="form-group mb-4">
                ...
                <select disabled style="background:rgba(10, 139, 255, 0.5); font-size:1.4em; letter-spacing: 5px;" class="container text-center form-control" name="tipo_equipo" id="">
                    <?php
                    $resultadoSerie = mysqli_query($conexion, "SELECT distinct serie_equipo
                    FROM m_rim.gd_serie where serie_equipo != '' ORDER BY serie_equipo ASC;") or
                        die(mysqli_error($conexion));
                    while ($serie_equipo = mysqli_fetch_array($resultadoSerie)) {
                        if ($serie_equipo['serie_equipo'] == $res['serie_equipo'])
                            echo "<option value=\"" . $serie_equipo['serie_equipo'] . "\" selected>" . $serie_equipo['serie_equipo'] . "</option>";
                        else
                            echo "<option value=\"" . $serie_equipo['serie_equipo'] . "\">" . $serie_equipo['serie_equipo'] . "</option>";
                    }
                    ?>
                </select>
        ...
        <div class="row">
            ...
            <div class="col-3 col-sm">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="form-control" id="recepciona" name="recepciona" value="<?php echo $res['recepciona'] ?>" placeholder="Edite el tipo del producto">
                </div>
            </div>
        ...
        <div class="col">
            <span class="d-grid gap-2 d-md-flex">
                ...
                <button type="submit" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="btn btn-success d-flex align-items-center" name="submit_registro" id="guardar_editar" value="Guardar Cambios">
...
<?php
    ...
    echo 'No existe registro con ese id';
?>