...
<nav class="responsive">
  ...
  <img src="logoHPM.jpg" alt="Foto Hpm">
  <ul class="nav">
    <li><a class="active" href="../../inventarioti/pantallas/home.php">Inicio</a></li>
    <li><a href="../pantallas/ingresarSerie.php">Registrar Oc</a></li>
    <li id="submenu"><a href="#">Ingresar Datos</a>
      <ul>
        <li><a class="" href="../pantallas/ingresarModelo.php">Ingresar Modelo</a></li>
