...
<?php 
    ...
    <div class="container text-center">
        <div class="row">
            <?php include('../formularios/formIngresarProveedor.php'); ?>
        </div>
        <div class="text-center mt-5">
            <h5 style="color: #adadad">No puede eliminar un proveedor asignado a un registro </h5>
        </div>
        <div class=" col-md-12 mt-5  ">
            <table  class="table table-striped table-hover" >
                ...
                <tbody class="table-group-divider">
                    <?php include('../crud/mostrarRegistros/mostrarProveedor.php');?>       
                </tbody>
            </table>
        </div>
    </div>
